...
acs_data <- acs_data %>%
    ...
    mutate(label_04 = str_replace_all(label_04,"18 years and over","18+ years"))%>%
    mutate(label_05 = str_replace_all(label_04,"American Indian and Alaska Native alone","First Nation"))%>%
    mutate(label_05 = str_replace_all(label_04,"Black or African American alone","Black or African American"))%>%
    mutate(label_05 = str_replace_all(label_04,"Native Hawaiian and Other Pacific Islander alone","Pacific Islander"))
...
ag18t24 <- c('18 years and over','20 to 24 years')
...
acs_data_convert <- acs_data %>%
    ...
    filter(label_04 %nin% c('10 to 14 years','15 to 19 years','5 to 9 years','62 years and over')) %>%
    ...
    mutate(percentEst = case_when(dropDownMain == 'Race and Ethnicity' ~ (yValue/raceTotal) * 100,
                                  dropDownMain == 'Sex' ~ (yValue/eduTotal) * 100,
                                  dropDownMain == 'Age' ~ (yValue/eduTotal) * 100,
